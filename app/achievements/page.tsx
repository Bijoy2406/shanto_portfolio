...
export default async function Achievements() {
  ...
  return (
    <main className="flex-grow bg-[#fcf9f8] min-h-screen">
      ...
      <ListContentSection name="achievements-content" isEmpty={items.length === 0} emptyMessage="No achievements yet.">
      ...
      <footer className="bg-[#f0f0f0] py-6 text-center border-t border-gray-200 animate-fade-in">
        <p className="text-sm text-gray-500">© 2026 Khondokar Shahriar Shanto.</p>
      </footer>
    </main>
  );
}
